...
public class LoadGeneratorProfileBuilderTest
{
    ...
    public void simple_build() throws Exception
    {
        ...
        Assert.assertEquals( "/index.html", loadGeneratorProfile.getSteps().get( 0).getResources().get( 0 ).getPath() );
    ...
    public void mix_resource_with_resource_group() throws Exception
    {
        ...
        Assert.assertEquals( "/cheese.html", loadGeneratorProfile.getSteps().get( 0).getResources().get( 0 ).getPath() );
        Assert.assertEquals( 8192, loadGeneratorProfile.getSteps().get( 0).getResources().get( 0 ).getSize() );
        Assert.assertEquals( "GET", loadGeneratorProfile.getSteps().get( 0).getResources().get( 0 ).getMethod() );

        Assert.assertEquals( "/index.html", loadGeneratorProfile.getSteps().get( 1).getResources().get( 0 ).getPath() );
        ...
        Assert.assertEquals( "/coffee.html", loadGeneratorProfile.getSteps().get( 2).getResources().get( 0 ).getPath() );
